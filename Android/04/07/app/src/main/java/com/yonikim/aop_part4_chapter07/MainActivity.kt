package com.yonikim.aop_part4_chapter07
...
import com.yonikim.aop_part4_chapter07.data.Repository
import com.yonikim.aop_part4_chapter07.data.models.PhotoResponse
import com.yonikim.aop_part4_chapter07.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
                        ...
                        if (wallpaperManager.isWallpaperSupported
                            ...
                            snackbar.setAction("배경 화면으로 저장") {
                                try {
                                    ...
                                    Snackbar.make(binding.root, "배경화면 저장 완료", Snackbar.LENGTH_SHORT).show()
                                } catch (exception: Exception) {
    ...
    companion object {
        private const val REQUEST_WRITE_EXTERNAL_STORAGE_PERMISSION = 201
    }
}