...
import com.yonikim.aop_part4_chapter05.databinding.ActivitySignInBinding
    ...
    private suspend fun getAccessToken(code: String) = withContext(Dispatchers.IO) {
        ...
        if (response.isSuccessful) {
            ...
            if (accessToken.isNotEmpty()) {
                ...
                Toast.makeText(this@SignInActivity, "ACCESS TOKEN 이 존재하지 않습니다.", Toast.LENGTH_SHORT)
                    .show()
            }
        }
    }
