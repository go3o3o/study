package com.yonikim.aop_part3_chapter06.myPage
...
import com.yonikim.aop_part5_chapter04.databinding.FragmentMypageBinding
                    ...
                    auth.signInWithEmailAndPassword(email, password)
                        .addOnCompleteListener(requireActivity()) { task ->
                            if (task.isSuccessful) {
                                ...
                                Toast.makeText(context, "로그인에 실패했습니다. 이메일 또는 비밀번호를 확인해 주세요.", Toast.LENGTH_SHORT).show()
                            }
                        }
